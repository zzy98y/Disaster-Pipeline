...
def index():
    ...
    df_sar = df[df['search_and_rescue']==1]
    sar_counts = df_sar.groupby('genre').count()['message']
    sar_names = list(sar_counts.index)
    ...
    graphs = [
        {
            ...
            'layout': {
                'title': 'Distribution of Search and Rescure Message Genres',
                'yaxis': {
                    'title': "Count"
                },
                'xaxis': {
